...
Then browse to http://localhost:9999 and if you see \<Engine Management\> button it works. Note that all the paths are paths __on the server__, __NOT__ the path on the computer that runs the browser. The binary executables of the engines need to be placed at respective paths __on the server__.
